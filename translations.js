...
const translations = {
  en: {
    ...
    "about-text-2": "Our team consists of enthusiastic professionals with knowledge in modern networking, cloud services, and security technologies. We combine expertise with attention to each client's needs.",    
    "about-text-3": "Our aim is to build trust with our clients, offering support, flexibility, and customized solutions that ensure stability and security for their infrastructure.",
    "about-text-4": "Although we are a new company, we continuously invest in knowledge, tools, and processes to deliver high-quality services. HellasNOC is here to help businesses grow securely and reliably.",
